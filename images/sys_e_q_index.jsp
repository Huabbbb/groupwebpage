...
%><%=upage.showSetDoctype("<!DOCTYPE HTML>")%><%=upage.showOnPageLoading(true)%>
<!--
...
%>
	...
	<link rel="stylesheet" href="/system/site/_js/css/quickbuild.css" type="text/css"><%upage.putAllViewStyle(out, null);
%></head>
